...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    hrChainAuthUserSubject.add(
      HrChainAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HrChainAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HrChainAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HrChainAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    hrChainAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
